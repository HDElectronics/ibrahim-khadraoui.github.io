...
const commands: Record<string, () => string[]> = {
  ...
  about: () => [
    "Hi, I'm Ibrahim!",
    'An embedded systems engineer who designs and builds custom PCBs,',
    'from schematic to layout to bring-up. This portfolio is styled like',
    'VS Code because I spend most of my time here anyway.',
  ],
  skills: () => [
    'Technical Skills:',
    '  Microcontrollers: ATmega328P, STM32F103, Arduino',
    '  PCB Design:        KiCad, Schematic Capture, PCB Layout',
    '  Interfaces:        USB HID, I2C, SPI, UART, LoRa, UWB',
    '  Networking:         Cisco (CCNA)',
    '  Tools:              Git, Linux',
  ],
  projects: () => [
    'Featured Projects:',
    '  1. Contactless Hand Sanitizer',
    '  2. Fast Line Follower (BATLFOLLOWER)',
    '  3. Odometer',
    '  4. USB HID Gamepad',
    '  5. PCB Business Card',
    '',
  ...
  contact: () => [
    ...
    '  GitHub:   github.com/HDElectronics',
    '  LinkedIn: linkedin.com/in/ibrahim-khadraoui',
  ],
  themes: () => [
    'Available themes:',
